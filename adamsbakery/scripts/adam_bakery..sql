...
-- (sisanya sama, tapi semua nama schema ganti ke `adamsbakery`)
...
CREATE TABLE IF NOT EXISTS `packages` (
  ...
  `gambar` varchar(255) COLLATE utf8mb4_general_ci DEFAULT 'placeholder.jpg',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `image` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table adam_bakery.packages: ~11 rows (approximately)
INSERT INTO `packages` (`id`, `nama`, `deskripsi`, `harga`, `gambar`, `created_at`, `image`) VALUES
	...
	(11, 'paket nastar', 'nastar nanas', 6000.00, 'placeholder.jpg', '2025-10-04 14:51:07', '1759589467_paket nastar.jpg'),
	(12, 'paket nastar', 'nastar nanas', 6000.00, 'placeholder.jpg', '2025-10-04 15:03:13', '1759590193_paket nastar.jpg'),
	(13, 'paket nastar', 'nastar nanas', 6000.00, 'placeholder.jpg', '2025-10-04 15:09:43', '1759590583_paket nastar.jpg'),
	(15, 'ambatukam', 'WFeegawggwag', 50000.00, 'placeholder.jpg', '2025-10-04 15:31:53', '1759591913_paket roti cokelat X keju.jpg');
...
-- Dumping data for table adam_bakery.products: ~12 rows (approximately)
INSERT INTO `products` (`id`, `category_id`, `nama`, `harga`, `kategori`, `deskripsi`, `image`, `created_at`, `updated_at`) VALUES
	...
	(3, 1, 'Croissant Butter', 18000.00, 'Roti Manis', 'Croissant berlapis dengan butter premium, renyah di luar lembut di dalam', 'placeholder.jpg', '2025-09-17 16:22:57', '2025-09-17 16:22:57'),
	...
	(15, 3, 'ambatukam', 5000.00, 'Roti Manis', 'roti khas ngawi', '1759589421_kukus unik.jpg', '2025-10-04 14:50:21', '2025-10-04 14:50:21'),
	(16, 3, 'roti hot dawg', 5000.00, 'Roti Manis', 'roti sosis', '1759591216_hot dawg.jpg', '2025-10-04 15:20:16', '2025-10-04 15:20:16');
