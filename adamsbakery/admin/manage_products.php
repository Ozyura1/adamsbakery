    ...
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
            case 'add':
                ...
                $sql = "INSERT INTO products (nama, harga, category_id, deskripsi, image) 
                        VALUES ('$nama', '$harga', '$category_id', '$deskripsi', '$imageName')";
                if (!$conn->query($sql)) {
            ...
            case 'update':
                ...
                $sql = "UPDATE products SET 
                        nama='$nama', harga='$harga', category_id='$category_id', deskripsi='$deskripsi' $sqlImg
                        WHERE id='$id'";
